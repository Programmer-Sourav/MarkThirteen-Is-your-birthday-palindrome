...
function clickHandler(e) {
  ...
  if (bdayString !== "") {
    ...
    if (!isPalindrome) {
      ...
      if (ctr1 > ctr2) {
        resultDiv.innerText = `The nearest previous palindrome date is ${prevDate.day}-${prevDate.month}-${prevDate.year}, you missed by ${ctr2} days.`;
        resultDiv.style.backgroundColor = "RED";
        resultDiv.style.color = "white";
      } else {
        resultDiv.innerText = `The nearest future palindrome date is ${nextDate.day}-${nextDate.month}-${nextDate.year}, you missed by ${ctr1} days.`;
